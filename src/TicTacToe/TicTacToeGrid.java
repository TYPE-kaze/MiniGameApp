...
public class TicTacToeGrid {
     ...
     */
    public boolean isGridPositionFree(int gridRow, int gridColumn) throws IndexOutOfBoundsException {
     ...
     */
    public GridStatus getMarkAt(int gridPosition) throws IndexOutOfBoundsException {
        return grid[convertPositionNumberToRowNumber(gridPosition)][convertPositionNumberToColumnNumber(gridPosition)];
    }
     ...
     * change to 2, if it was previously 2 it will switch to 1.
     */
     ...
     * if there are 3 Xs or Os in a line horizontally, vertically or diagonally.
     *
    ...
    public boolean isWin() {
        ...
        return isEveryMarkInGridLineSame(diagonalLineUp);
    }
